                    ...
                    <>
                      <div className="w-[5.5rem] shrink-0 space-y-0.5 sm:w-24">
                        ...
                        <div className="flex h-9 min-h-9 items-stretch gap-1">
                          <input type="number" min={0} value={line.quantity ?? ''} onChange={e => onUpdateItem(line.id, { quantity: parsePsiIntegerQuantityInputOptional(e.target.value) })} className={`${psiOrderBillCompactLineInputClass} min-w-0 flex-1`} placeholder="0" />
