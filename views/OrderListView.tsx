...
import { Clock, Layers, Plus, History, User, Sliders, X, Trash2, FileText, Check, ChevronDown, ChevronRight, ScrollText, UserPlus, Filter, Pencil, ClipboardList, Search, Package, RotateCcw, ArrowDownToLine, Split } from 'lucide-react';
