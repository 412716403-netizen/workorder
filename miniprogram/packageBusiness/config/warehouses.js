...
const WAREHOUSE_SHORTCUTS = [
  {
    ...
    path: '/packageBusiness/psi-warehouse-flow/psi-warehouse-flow',
  ...
  },
  {
    ...
    path: '/packageBusiness/psi-warehouse-stocktake/psi-warehouse-stocktake',
  ...
  },
  {
    ...
    path: '/packageBusiness/psi-warehouse-transfer/psi-warehouse-transfer',
