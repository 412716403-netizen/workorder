...
const OUTSOURCE_SHORTCUTS = [
  {
    ...
    path: '/packageBusiness/production-outsource-dispatch/production-outsource-dispatch',
  ...
  },
  {
    ...
    path: '/packageBusiness/production-outsource-receive/production-outsource-receive',
  ...
  },
  {
    ...
    path: '/packageBusiness/production-outsource-flow/production-outsource-flow',
