...
const REWORK_SHORTCUTS = [
  {
    ...
    path: '/packageBusiness/production-rework-pending/production-rework-pending',
  ...
  },
  {
    ...
    path: '/packageBusiness/production-rework-defect-flow/production-rework-defect-flow',
  ...
  },
  {
    ...
    path: '/packageBusiness/production-rework-report-flow/production-rework-report-flow',
