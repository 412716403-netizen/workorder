...
const ORDER_CENTER_SHORTCUTS = [
  {
    ...
    path: '/packageBusiness/production-order-flow/production-order-flow',
    permission: null,
  },
  {
    id: 'report-history',
    ...
    path: '/packageBusiness/production-order-report-history/production-order-report-history',
  ...
  },
  {
    ...
    path: '/packageBusiness/production-order-pending-stock/production-order-pending-stock',
