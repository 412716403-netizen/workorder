...
Page({
  ...
  onCreateTap() {
    ...
    wx.navigateTo({ url: '/packageBusiness/finance-receipt-edit/finance-receipt-edit' });
  },

  onFlowTap() {
    wx.navigateTo({ url: '/packageBusiness/finance-receipt-flow/finance-receipt-flow' });
  },
