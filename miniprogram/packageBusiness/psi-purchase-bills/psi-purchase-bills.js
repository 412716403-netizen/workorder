...
Page({
  ...
  onCreateTap() {
    ...
    wx.navigateTo({ url: '/packageBusiness/psi-purchase-bill-edit/psi-purchase-bill-edit' });
  },

  onFlowTap() {
    wx.navigateTo({ url: '/packageBusiness/psi-purchase-bill-flow/psi-purchase-bill-flow' });
  },
