...
const _require3 =
  ...
  require('../utils/financeReceipts.js'),emptyReceiptForm = _require3.emptyReceiptForm,formFromRecord = _require3.formFromRecord,formVisibility = _require3.formVisibility,validateReceiptForm = _require3.validateReceiptForm,buildReceiptSavePayload = _require3.buildReceiptSavePayload,buildWorkerPickerOptions = _require3.buildWorkerPickerOptions,initialCustomDataForCategory = _require3.initialCustomDataForCategory,categoriesForReceipt = _require3.categoriesForReceipt,normalizeFinanceCategories = _require3.normalizeFinanceCategories;
const _require4 =
...
Page({
  ...
  async bootstrap() {
    ...
    try {
      ...
      const categories = categoriesForReceipt(normalizeFinanceCategories(normalizeMasterList(categoriesRaw)));
