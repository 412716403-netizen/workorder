...
Page({
  ...
  onLoad(options) {
    ...
    if (docNumber) {
      wx.redirectTo({
        url: `/packagePsi/psi-warehouse-stocktake-detail/psi-warehouse-stocktake-detail?docNumber=${encodeURIComponent(docNumber)}`
      });
      return;
    }
  ...
  onCreateTap() {
    ...
    wx.navigateTo({ url: '/packagePsi/psi-warehouse-stocktake-edit/psi-warehouse-stocktake-edit' });
  },
