...
Page({
  ...
  onCreateTap() {
    ...
    wx.navigateTo({ url: '/packagePsi/psi-purchase-bill-edit/psi-purchase-bill-edit' });
  },

  onFlowTap() {
    wx.navigateTo({ url: '/packagePsi/psi-purchase-bill-flow/psi-purchase-bill-flow' });
  },
  ...
  async bootstrap() {
    ...
    try {
      const [purchaseBills, productMeta, dictionaries, warehouses] = await Promise.all([
