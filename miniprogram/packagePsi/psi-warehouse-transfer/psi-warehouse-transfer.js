...
Page({
  ...
  onLoad(options) {
    ...
    if (docNumber) {
      wx.redirectTo({
        url: `/packagePsi/psi-warehouse-transfer-detail/psi-warehouse-transfer-detail?docNumber=${encodeURIComponent(docNumber)}`
      });
      return;
    }
  ...
  onCreateTap() {
    ...
    wx.navigateTo({ url: '/packagePsi/psi-warehouse-transfer-edit/psi-warehouse-transfer-edit' });
  },
