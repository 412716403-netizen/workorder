...
const _require3 = require('../config/purchaseBills.js'),PSI_TYPE = _require3.PSI_TYPE;
const _require4 = require('../utils/purchaseBills.js'),mapPurchaseBillDetailView = _require4.mapPurchaseBillDetailView;
...
Page({
  ...
  onEditTap() {
    ...
    wx.navigateTo({
      url: `/packagePsi/psi-purchase-bill-edit/psi-purchase-bill-edit?docNumber=${encodeURIComponent(this.data.docNumber)}`
    });
  },
  ...
  onSourceOrderTap(e) {
    ...
    wx.navigateTo({
      url: `/packagePsi/psi-purchase-order-detail/psi-purchase-order-detail?docNumber=${encodeURIComponent(orderNumber)}`
    });
  },
  ...
  async loadDetail() {
    ...
    try {
      const _await$Promise$all = await Promise.all([
        ...
        ),purchaseBills = _await$Promise$all[0],products = _await$Promise$all[1],categories = _await$Promise$all[2],dictionaries = _await$Promise$all[3],warehouses = _await$Promise$all[4],linkedFinanceAmount = _await$Promise$all[5];
