...
Page({
  ...
  onAddTodoTap() {
    ...
    openTodoEdit({
      seed: {
        ...
        href: `/psi?tab=SALES_ORDER&psiDoc=${encodeURIComponent(doc)}`,
      },
    });
  },
  ...
  onEditTap() {
    ...
    wx.navigateTo({
      url: `/packagePsi/psi-sales-order-edit/psi-sales-order-edit?docNumber=${encodeURIComponent(this.data.docNumber)}`
    });
  },
  ...
  onAllocateTap(e) {
    ...
    wx.navigateTo({
      url: `/packagePsi/psi-sales-order-allocate/psi-sales-order-allocate?docNumber=${encodeURIComponent(this.data.docNumber)}&lineGroupId=${encodeURIComponent(lineGroupId)}`
    });
  },
