...
Page({
  ...
  onAddTodoTap() {
    ...
    openTodoEdit({
      seed: {
        ...
        href: `/psi?tab=PURCHASE_ORDER&psiDoc=${encodeURIComponent(doc)}`,
      },
    });
  },
  ...
  onEditTap() {
    ...
    wx.navigateTo({
      url: `/packagePsi/psi-purchase-order-edit/psi-purchase-order-edit?docNumber=${encodeURIComponent(this.data.docNumber)}`
    });
  },
