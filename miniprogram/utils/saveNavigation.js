...
const LIST_ROUTES = {
  ...
  PSI_PURCHASE_ORDERS: '/packagePsi/psi-purchase-orders/psi-purchase-orders',
  PSI_PURCHASE_ORDER_FLOW: '/packagePsi/psi-purchase-order-flow/psi-purchase-order-flow',
  PSI_PURCHASE_BILLS: '/packagePsi/psi-purchase-bills/psi-purchase-bills',
  PSI_PURCHASE_BILL_FLOW: '/packagePsi/psi-purchase-bill-flow/psi-purchase-bill-flow',
  PSI_SALES_ORDERS: '/packagePsi/psi-sales-orders/psi-sales-orders',
  PSI_SALES_ORDER_FLOW: '/packagePsi/psi-sales-order-flow/psi-sales-order-flow',
  PSI_SALES_ORDER_PENDING_SHIP: '/packagePsi/psi-sales-order-pending-ship/psi-sales-order-pending-ship',
  PSI_SALES_BILLS: '/packagePsi/psi-sales-bills/psi-sales-bills',
  PSI_SALES_BILL_FLOW: '/packagePsi/psi-sales-bill-flow/psi-sales-bill-flow',
  PSI_WAREHOUSES: '/packagePsi/psi-warehouses/psi-warehouses',
  PSI_WAREHOUSE_FLOW: '/packagePsi/psi-warehouse-flow/psi-warehouse-flow',
  PSI_WAREHOUSE_PRODUCT_FLOW: '/packagePsi/psi-warehouse-product-flow/psi-warehouse-product-flow',
  PSI_WAREHOUSE_TRANSFER: '/packagePsi/psi-warehouse-transfer/psi-warehouse-transfer',
  PSI_WAREHOUSE_STOCKTAKE: '/packagePsi/psi-warehouse-stocktake/psi-warehouse-stocktake',
  FINANCE_RECEIPTS: '/packageFinance/finance-receipts/finance-receipts',
  FINANCE_RECEIPT_FLOW: '/packageFinance/finance-receipt-flow/finance-receipt-flow',
  FINANCE_PAYMENTS: '/packageFinance/finance-payments/finance-payments',
  FINANCE_PAYMENT_FLOW: '/packageFinance/finance-payment-flow/finance-payment-flow',
  FINANCE_ACCOUNTS: '/packageFinance/finance-accounts/finance-accounts',
  FINANCE_ACCOUNT_FLOW: '/packageFinance/finance-account-flow/finance-account-flow',
  FINANCE_ACCOUNT_TYPES: '/packageFinance/finance-account-types/finance-account-types',
  ...
  SETTINGS_NODES: '/packageBusiness/settings-archive-list/settings-archive-list?id=nodes',
  SETTINGS_WAREHOUSES: '/packageBusiness/settings-archive-list/settings-archive-list?id=warehouses',
  SETTINGS_FINANCE_CATEGORIES:
    '/packageBusiness/settings-archive-list/settings-archive-list?id=finance_categories',
};
