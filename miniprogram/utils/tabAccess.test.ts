...
const {
  ...
  buildVisibleTabItems: (ctx: { tenantRole?: string; permissions?: string[] } | null) => Array<{ key: string }>;
  resolveDefaultTabPath: (ctx: { tenantRole?: string; permissions?: string[] } | null) => string;
};
