...
const WAREHOUSE_SHORTCUTS = [
  {
    ...
    path: '/pages/psi-warehouse-flow/psi-warehouse-flow',
  ...
  },
  {
    ...
    path: '/pages/psi-warehouse-stocktake/psi-warehouse-stocktake',
  ...
  },
  {
    ...
    path: '/pages/psi-warehouse-transfer/psi-warehouse-transfer',
