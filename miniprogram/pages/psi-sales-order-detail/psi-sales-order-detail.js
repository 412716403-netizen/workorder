...
Page({
  ...
  onEditTap() {
    ...
    wx.navigateTo({
      url: `/pages/psi-sales-order-edit/psi-sales-order-edit?docNumber=${encodeURIComponent(this.data.docNumber)}`,
    });
  },
  ...
  onAllocateTap(e) {
    ...
    wx.navigateTo({
      url: `/pages/psi-sales-order-allocate/psi-sales-order-allocate?docNumber=${encodeURIComponent(this.data.docNumber)}&lineGroupId=${encodeURIComponent(lineGroupId)}`,
    });
  },
