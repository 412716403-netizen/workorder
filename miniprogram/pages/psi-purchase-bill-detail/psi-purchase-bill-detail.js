...
Page({
  ...
  onEditTap() {
    ...
    wx.navigateTo({
      url: `/pages/psi-purchase-bill-edit/psi-purchase-bill-edit?docNumber=${encodeURIComponent(this.data.docNumber)}`,
    });
  },
  ...
  onSourceOrderTap(e) {
    ...
    wx.navigateTo({
      url: `/pages/psi-purchase-order-detail/psi-purchase-order-detail?docNumber=${encodeURIComponent(orderNumber)}`,
    });
  },
