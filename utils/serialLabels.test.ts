...
describe('formatItemCodeSerialLabel', () => {
  it('formats as planNumber and zero-padded serial without letter prefix', () => {
    expect(formatItemCodeSerialLabel('PLN12', 1)).toBe('PLN12-0001');
  });
  ...
  it('pads to 4 digits', () => {
    expect(formatItemCodeSerialLabel('PLN5', 42)).toBe('PLN5-0042');
  });
});
